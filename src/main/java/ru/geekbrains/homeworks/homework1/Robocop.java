...
public class Robocop implements Movement {
    ...
    public Robocop (String name, int powerJump, int powerRun) {
        this.name = name;
    ...
    public void jump(Barriers wall) {
        if (powerJump >= wall.height) {
            count++;
            System.out.printf("Robocop %s jumped over the wall, count of barriers is %d\n", name, count);

        }
        else {
            System.out.printf("Robocop %s too weak\n", name);
        }
    }
    ...
    public void run(Barriers track) {
        if (powerRun >= track.length) {
            count++;
            System.out.printf("Robocop %s ran down the track, count of barriers is %d\n", name, count);
    ...
    public void lose () {
        System.out.printf("Robocop %s end with count = %d\n", name, count);
    }
